    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='DefaultVendorName', max_length=100)),
                ('image', models.ImageField(default='category.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='This is the product description.', null=True)),
                ('address', models.CharField(default='123 Main St', max_length=100)),
                ('contact', models.CharField(default='+91 999000', max_length=100)),
